...
def create_RP_for_UD_OOD(template_work_program:str,data_work_program:str,end_folder:str):
    ...
    try:
        ...
        messagebox.showerror('Диана Создание рабочих программ',
                             f'Возникла проблема с считыванием данных из файла. Вероятнее всего проблема заключается в том что вы открыли файл созданный в Excel 2007\n'
                             f'в более новом текстовом редакторе. Откройте файл и сохраните его.После чего попробуйте снова')
